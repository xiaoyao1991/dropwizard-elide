...
Similar to the [Elide example](https://github.com/yahoo/elide/tree/master/elide-example/elide-persistence-mysql-example). This example demonstrates how to use the dropwizard-elide bundle.
